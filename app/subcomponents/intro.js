  ...
  return (
    <main>
      ...
      <p className="text-md mb-4 ">
        ...
        development process, we need to select a suitable UI toolkit to build
        the app’s user interface.
      </p>

      <p className="text-md mb-4">
        In this article, we will explore the features and benefits of the
        Amazing Crime App, a cutting-edge solution designed to streamline the
        process of tracking and reporting criminal incidents.
      </p>
    </main>
  );
}
